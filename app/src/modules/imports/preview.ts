...
const DEFAULT_FIELDS: Record<string, string> = {
  ...
  usuario: 'user_name',
  kit: 'kit',
  'nº individual': 'individual_number',
  'no individual': 'individual_number',
  '1ª utiliz.': 'first_use_date',
  'data da inspeção': 'inspection_date',
  'inspecionado por': 'inspected_by',
  'próxima insp.': 'next_inspection_date',
  'proxima insp.': 'next_inspection_date',
  'local da inspeção': 'inspection_location',
